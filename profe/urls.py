...
urlpatterns = [
    ...
    path('conta/cambiar-contrasinal/', login_required(auth_views.PasswordChangeView.as_view(template_name='password_change_form.html')), name='password_change'),
    ...
    path('conta/preferencias/', login_required(views.ModificarDatosProfe.as_view()), name='edit_profe_data'),
    path('conta/eliminar/', login_required(views.eliminar_profe), name='delete_profe'),
